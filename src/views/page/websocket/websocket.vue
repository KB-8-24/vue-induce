      ...
      socket.onopen = () => {
        socket.send(
          JSON.stringify({
            ...
            action: "join",
            token:
              "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJsb2dpbm5hbWUiOiJzdXBlcmFkbWluIiwiZXhwIjoxNjQ4MTExNDU1LCJ1c2VySWQiOiI5OWJjODFlMmM2NzQ0MTgzOTFmZWRkNDM5ZDQ1Nzc5OSIsInV1aWQiOiI3ZDAyNzc4MS0xNzc2LTQzYzQtYWJlNC03NTJjZjI4MjJkMWEifQ.PD0DWPXdiElCvFAgfZeP0RZI_yOBUeWjC4Md8gnjGnc"
          })
        )
      }
